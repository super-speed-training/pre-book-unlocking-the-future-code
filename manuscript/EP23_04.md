...
<ion-grid style="padding-bottom: 50px">
    <ion-row class="item-row">
      <ion-col col-6 class="item" *ngFor="let p of Products">
...
export class PaymentPage {
  ...
  constructor(public navCtrl: NavController, public platform: Platform, private http: HTTP, public navParams: NavParams) {
    ...
    if (!this.platform.is('core') && !this.platform.is('mobileweb')) {
      ...
      //เรียก /api/Order/GetByReferenceCode/ โดยใช้ ReferenceCode ที่รับมา
        .then(data => {
  ...
  <ion-grid text-center no-padding>
    ...
    <ion-row>
      ...
      <ion-col col-12 class="grey-i">
        <div *ngFor="let p of OrderedProducts">{{ p }}</div>
